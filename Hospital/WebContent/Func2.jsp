              ...
              <form name="form2" method="post" action="FuncSQL.action" onSubmit="return mycheck()" >
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"  class="t1">
                    ...
                    <td bgcolor="#D5E4F4"><strong>Count</strong></td>
                    <td bgcolor="#D5E4F4"><strong>Max</strong></td>
                    <td bgcolor="#D5E4F4"><strong>Min</strong></td>
                    <td bgcolor="#D5E4F4"><strong>Avg</strong></td>
                    <td bgcolor="#D5E4F4"><strong>Sum</strong></td> 
                  </tr>
