        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="AggExistsSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Exists：</td>
                    <td>
                      <select name="SearchRowE" id="SearchRowE">
                        <option value="Doctor_Specialty">專長</option>
                      </select>
                      <input name="SearchKeyE" type="text" class="text1" id="SearchKeyE"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
