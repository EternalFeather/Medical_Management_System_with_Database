      ...
      <table width="1500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">修改病人信息</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="PatientUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="Patient_ID" type="text" class="noshow" id="Patient_ID" value="<s:property value='cnbean.Patient_ID'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Name：</td>
                    <td><input name="Patient_Name" type="text" class="text2" id="Patient_Name" value="<s:property value='cnbean.Patient_Name'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Age：</td>
                    <td><input name="Patient_Age" type="text" class="text2" id="Patient_Age" value="<s:property value='cnbean.Patient_Age'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Disease：</td>
                    <td><input name="Patient_Disease" type="text" class="text2" id="Patient_Disease" value="<s:property value='cnbean.Patient_Disease'/>"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="修改病人信息">
                      &nbsp;&nbsp;
