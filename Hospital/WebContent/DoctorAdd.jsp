        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="DoctorAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Doctor_Name" type="text" class="text2" id="Doctor_Name"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Age：</td>
                    <td><input name="Doctor_Age" type="text" class="text2" id="Doctor_Age"></td>
                  </tr>
                 <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Specialty：</td>
                    <td><input name="Doctor_Specialty" type="text" class="text2" id="Doctor_Specialty"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="添加醫生信息">
                      &nbsp;&nbsp;
