        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="DepartmentAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Department_Subject" type="text" class="text2" id="Department_Subject"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>People：</td>
                    <td><input name="Department_People" type="text" class="text2" id="Department_People"></td>
                  </tr>
                 <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Field：</td>
                    <td><input name="Field" type="text" class="text2" id="Field"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="添加部門信息">
                      &nbsp;&nbsp;
