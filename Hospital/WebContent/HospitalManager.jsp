                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center"><a href="HospitalUpdate.action?Hospital_ID=${Hospital_ID}">修改</a> <a href="HospitalDel.action?Hospital_ID=${Hospital_ID}" onClick="return confirm('確定要刪除這家醫院的信息嗎？')">删除</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>
