      ...
      <table width="1500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">修改醫院信息</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="HospitalUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="Hospital_ID" type="text" class="noshow" id="Hospital_ID" value="<s:property value='cnbean.Hospital_ID'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Name：</td>
                    <td><input name="Hospital_Name" type="text" class="text2" id="Hospital_Name" value="<s:property value='cnbean.Hospital_Name'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Address：</td>
                    <td><input name="Hospital_Address" type="text" class="text2" id="Hospital_Address" value="<s:property value='cnbean.Hospital_Address'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Scale：</td>
                    <td>
                    <select name="Hospital_Scale" id="Hospital_Scale">
                      <option value="">請選擇</option>
                      <option value="big" 
                      <s:if test='cnbean.Hospital_Scale=="big"'>selected</s:if>
                      >big
                      </option>
                      <option value="middle" 
                      <s:if test='cnbean.Hospital_Scale=="middle"'>selected</s:if>
                      >middle
                      </option>
                      <option value="small" 
                      <s:if test='cnbean.Hospital_Scale=="small"'>selected</s:if>
                      >small
                      </option>
                    </select></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="修改醫院信息">
                      &nbsp;&nbsp;
