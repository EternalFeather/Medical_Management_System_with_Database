        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="ReportAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Report_PatientName" type="text" class="text2" id="Report_PatientName"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Disease：</td>
                    <td><input name="Report_Disease" type="text" class="text2" id="Report_Disease"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Medicine：</td>
                    <td><input name="Report_Medicine" type="text" class="text2" id="Report_Medicine"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="添加病歷信息">
                      &nbsp;&nbsp;
