        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="AggNotExistsSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>Not Exists：</td>
                    <td>
                      <select name="SearchRowNE" id="SearchRowNE">
