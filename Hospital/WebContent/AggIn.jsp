        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="AggInSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>In：</td>
                    <td>
                      <select name="SearchRowI" id="SearchRowI">
                      <option value="Doctor_Name">姓名</option>
                      <option value="Doctor_Age">年齡</option>
                      <option value="Doctor_Specialty">專長</option>
                      </select>
                      <input name="SearchKeyI" type="text" class="text1" id="SearchKeyI"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
