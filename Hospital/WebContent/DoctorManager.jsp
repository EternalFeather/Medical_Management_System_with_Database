        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="DoctorManager.action">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="28%" height="100" style="padding-left:20px;"> 功能導航： <u><a href="DoctorAdd.jsp">添加醫生信息</a></u></td>
                    <td width="36%">Search：
                     ...
                     <td width="36">
                     <a href="DoctorSQL2.jsp" onClick="return confirm('切換成手動修改!')">
                     <input type="button" name="button" id="button" value="跳轉至手動修改"></a></td>
                     <td width="36">
                     <a href="DoctorSQL.jsp" onClick="return confirm('切換成手動查詢!')">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"  class="t1">
                    ...
                    <td bgcolor="#D5E4F4"><strong>專長</strong></td>
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center"><a href="DoctorUpdate.action?Doctor_ID=${Doctor_ID}">修改</a> <a href="DoctorDel.action?Doctor_ID=${Doctor_ID}" onClick="return confirm('確定要刪除這個醫生的信息嗎？')">删除</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>
