...
function mycheck(){
   if(isNull(form1.SearchSQL.value)){  
   alert("請輸入查詢內容!"); 
   return false;
}
        ...
        <tr>
          ...
          <table width="1320" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="DepartmentSQL.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <input name="SearchSQL" type="text" style="height:50; width:400" id="SearchSQL"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="點擊查詢">
                      &nbsp;&nbsp;
