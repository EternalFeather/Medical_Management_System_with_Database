...
public class ReportAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		new ReportDao().Add(cnbean);
		    
		out.print("<script language='javascript'>alert('添加成功!');window.location='ReportManager.action';</script>");
		out.flush();out.close();return null;
