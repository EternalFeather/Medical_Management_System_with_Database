...
public class DoctorAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(list.size()>0)
		{
			out.print("<script language='javascript'>alert('醫生信息已經存在');history.back(-1);</script>");
		...
		new DoctorDao().Add(cnbean);
		    
		out.print("<script language='javascript'>alert('添加成功!');window.location='DoctorManager.action';</script>");
		out.flush();out.close();return null;
