...
public class DepartmentAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		new DepartmentDao().Add(cnbean);
		    
		out.print("<script languPeople='javascript'>alert('添加成功!');window.location='DepartmentManager.action';</script>");
		out.flush();out.close();return null;
