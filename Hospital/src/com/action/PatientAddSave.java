...
public class PatientAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(list.size()>0)
		{
			out.print("<script language='javascript'>alert('病人醫生信息已經存在');history.back(-1);</script>");
		...
		new PatientDao().Add(cnbean);
		    
		out.print("<script language='javascript'>alert('添加成功!');window.location='PatientManager.action';</script>");
		out.flush();out.close();return null;
